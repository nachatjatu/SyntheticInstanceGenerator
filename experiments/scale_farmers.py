...
# CORE BUILDERS
# =========================
def build_instance(instance_generator, graph, instance_id, n_ints, scale_factor, seed=n_id):
...
def main():
    ...
    platform, _ = build_instance(instance_generator, graph, n_id, N_INTS, scale_factor=scale_factor, seed=instance_id)
    ...
    # save results
    results_path = Path(f"data/results_scaling_farmers/{n_id}.json")
